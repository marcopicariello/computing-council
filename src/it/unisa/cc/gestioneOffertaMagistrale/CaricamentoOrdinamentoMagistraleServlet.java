...
/**
 * Servlet implementation class CaricamentoOrdinamentoMagistarleServlet
 */
@WebServlet("/CaricamentoOrdinamentoMagistarleServlet")
public class CaricamentoOrdinamentoMagistraleServlet extends HttpServlet {
     ...
     */
    public CaricamentoOrdinamentoMagistraleServlet() {
        super();
